...
```bash
poetry run caribou run aws_small_sync_example-version_number -a '{"execute_1": true, "execute_2": false, "execute_1": true}'
```
...
```bash
poetry run caribou remove aws_small_sync_example-version_number
```
